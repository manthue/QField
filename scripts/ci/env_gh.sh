...
TMP_CI_UPLOAD_ARTIFACT_ID_SAFE=$(echo "${TMP_CI_UPLOAD_ARTIFACT_ID}" | sed 's#[^A-Za-z0-9._-]#-#g')
...
export CI_UPLOAD_ARTIFACT_ID=${CI_UPLOAD_ARTIFACT_ID:=${TMP_CI_UPLOAD_ARTIFACT_ID_SAFE}}
